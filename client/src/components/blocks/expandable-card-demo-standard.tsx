...
function truncateSentence(sentence:string) {
  // Check if the sentence length is more than 34 characters
  if (sentence.length > 34) {
    // Return the first 34 characters and append "..."
    return sentence.substring(0, 34) + "...";
  } else {
    // If the sentence is already 34 characters or less, return it as is
    return sentence;
  }
}
